...
import { ConversionJourney, TrackedLink, WhatsAppLink } from '../components/roadready/conversion-journey';
import { PhotographySlot } from '../components/roadready/photography-slot';
import { PRODUCT_JOBS } from '../lib/roadready';

const resultCases = [
  { number: '01', title: 'The cabin reset', image: '/images/roadready-cabin.png', alt: 'A hand wiping a car steering wheel with an orange microfiber towel', copy: 'For the steering wheel, dash, console and touchpoints that make a used car feel used.' },
  { number: '02', title: 'The first proper wash', image: '/images/roadready-wash.png', alt: 'A charcoal wash mitt cleaning the wet bonnet of a silver car', copy: 'A simple exterior routine that replaces the random sponge-and-detergent approach.' },
  { number: '03', title: 'The finishing pass', image: '/images/roadready-tyre.png', alt: 'A hand applying finish to a car tyre with an orange foam applicator', copy: 'Tyres, trim and glass—the small areas that make the whole car look intentionally cared for.' },
];
  ...
  return (
    <main id="top">
      ...
      <header className="site-header">
        <a className="wordmark" href="#top" aria-label="RoadReady home">ROAD<span>READY</span></a>
      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <p className="hero-deck">DIY car-cleaning kits for used-car owners in Sri Lanka. RoadReady helps you choose a simple first-clean routine with every item assigned a clear job.</p>
        ...
        <PhotographySlot className="hero-photo" index="01" title="Complete kit beside the car" note="RoadReady concept photography" ratio="landscape" src="/images/roadready-hero.png" alt="An unbranded charcoal and orange car-care kit beside a silver car in a home driveway" priority />
        <div className="hero-side-note" aria-hidden="true"><span>ONE KIT</span><span>CLEAR JOBS</span><span>NO GUESSWORK</span></div>
      </section>

      <section className="proof-bar" aria-label="RoadReady purchase process">
      ...
      <section className="problem section-shell">
        ...
        <div className="problem-copy">
          ...
          <p>Most first-time care routines begin with too much advice and no sequence. RoadReady starts with the jobs you want to tackle, then puts them in a simple order.</p>
        </div>
      ...
      <section className="results section-shell" id="results">
        ...
        <div className="use-case-grid">
          {resultCases.map((item) => <article key={item.number}>
            <PhotographySlot index={item.number} title={`${item.title} — in action`} note="RoadReady concept photography" ratio="portrait" src={item.image} alt={item.alt} />
      ...
      <section className="offer section-shell" id="inside">
        ...
        <div className="offer-grid">
          <PhotographySlot index="05" title="The complete RoadReady reset" note="RoadReady concept photography" ratio="square" src="/images/roadready-kit.png" alt="An unbranded charcoal and orange car-care kit arranged on a workshop mat" />
          <div className="offer-copy">
            <p className="kicker">A SIMPLE FIRST-CLEAN ROUTINE</p><h2>THE ROADREADY<br /><span>RESET.</span></h2>
      ...
      <footer><a className="wordmark" href="#top">ROAD<span>READY</span></a><p>Car-care setups for new-to-you cars in Sri Lanka.</p><a href="#top">BACK TO TOP ↑</a></footer>
